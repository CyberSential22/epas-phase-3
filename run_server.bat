...
python -c "from app import create_app, db; app = create_app('default'); ctx = app.app_context(); ctx.push(); db.create_all(); print('        Database tables created / verified.'); ctx.pop()" 2>nul
if %errorlevel% neq 0 (
